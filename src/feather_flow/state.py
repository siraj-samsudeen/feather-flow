"""State management for feather-flow — watermarks, run history, schema versioning."""
    ...
    def init_state(self) -> None:
        ...
        try:
            ...
            if row is None:
                ...
                raise RuntimeError(
                    f"State DB schema version {row[0]} is newer than feather-flow "
                    f"version {SCHEMA_VERSION}. Upgrade feather-flow."
                )
        finally:
            con.close()
