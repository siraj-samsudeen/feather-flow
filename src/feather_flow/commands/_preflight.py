...
from feather_flow.planner import (
    auto_derive_int_pk_column,
    auto_derive_timestamp_column,
    pick_plan,
)
from feather_flow.preflight_banner import render as render_banner
from feather_flow.sources import StreamSchema
from feather_flow.transports.registry import TRANSPORT_CLASSES
...
# Alias builtins.input so tests can monkeypatch feather_flow.commands._preflight.input.
